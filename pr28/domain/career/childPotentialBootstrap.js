...
export class ChildPotentialBootstrap {
    create({ player, profile = {} } = {}) {
        ...
        player.overall = Number.isFinite(Number(profile.overall)) ? Number(profile.overall) : Math.min(40, startingPotential);
        ...
        return { potentialProfile, potential: startingPotential, overall: player.overall, independent: true };
    }
}
