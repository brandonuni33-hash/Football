...
export function installCoreStyles() {
    ...
    style.textContent = `
        ...
        .event-modal-overlay{position:absolute;inset:0;background:rgba(2,6,23,.88);backdrop-filter:blur(20px);z-index:100;display:flex;align-items:center;justify-content:center;padding:20px;overflow:hidden;overscroll-behavior:none}
        .event-modal-card{background:#1e293b;border:1.5px solid var(--border-glass);border-radius:26px;padding:22px;width:100%;max-width:360px;max-height:calc(100dvh - 40px);overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;touch-action:pan-y;box-shadow:0 20px 40px rgba(0,0,0,.8);scrollbar-width:thin;scroll-behavior:auto}
