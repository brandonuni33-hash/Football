...
.stp-creation-body{position:relative;overflow:hidden;min-height:100%;background:linear-gradient(180deg,#0b0b0b 0%,#070707 52%,#050505 100%);color:#f7f7f4;display:flex;flex-direction:column;font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.stp-creation-material{position:absolute;inset:0;pointer-events:none;overflow:hidden}.stp-creation-material:before,.stp-creation-material:after,.stp-creation-material i{content:"";position:absolute;height:1px;width:145%;left:-20%;transform:rotate(-28deg);background:linear-gradient(90deg,transparent,rgba(255,255,255,.024),transparent)}.stp-creation-material:before{top:20%}.stp-creation-material i{top:52%;background:linear-gradient(90deg,transparent,rgba(245,166,35,.035),transparent)}.stp-creation-material:after{top:78%}.stp-creation-material b{position:absolute;width:520px;height:520px;border-radius:50%;border:1px solid rgba(255,255,255,.018);left:-330px;top:190px}.stp-creation-material em{position:absolute;width:360px;height:360px;border-radius:50%;border:1px solid rgba(245,166,35,.022);right:-255px;bottom:20px}.stp-creation-top,.stp-creation-hero,.stp-body-panel,.stp-body-note,.stp-creation-footer{position:relative;z-index:1}.stp-creation-top{padding:18px 22px 0}.stp-creation-brand{display:flex;justify-content:space-between;align-items:center;font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:rgba(218,218,211,.58);font-weight:800}.stp-creation-brand strong{color:#f5a623}.stp-creation-progress{height:3px;background:rgba(255,255,255,.06);margin:18px -22px 0;position:relative}.stp-creation-progress i{position:absolute;inset:0 auto 0 0;background:linear-gradient(90deg,#ff7a00,#f5a623)}.stp-creation-hero{padding:16px 22px 5px}.stp-creation-eyebrow{color:#f5a623;font-size:12px;font-weight:850;letter-spacing:.12em;text-transform:uppercase}.stp-body-panel{margin:6px 22px 0;border:1px solid rgba(255,255,255,.08);border-radius:28px;overflow:hidden;background:rgba(9,9,9,.40)}.stp-body-stage{position:relative;min-height:520px;display:flex;align-items:flex-end;justify-content:center;padding:26px 20px 22px;overflow:hidden}.stp-body-stage:before{content:"";position:absolute;left:38px;right:38px;bottom:20px;height:1px;background:rgba(255,255,255,.08)}.stp-body-age{position:absolute;top:16px;right:16px;font-size:11px;color:#f5a623;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.stp-body-silhouette{position:relative;width:170px;height:405px;transform-origin:50% 100%;transform:scaleY(var(--height-scale));transition:transform .16s ease}.stp-body-silhouette .head{position:absolute;left:50%;top:0;transform:translateX(-50%);width:54px;height:62px;background:#373737;border-radius:48% 48% 44% 44%}.stp-body-silhouette .neck{position:absolute;left:50%;top:55px;transform:translateX(-50%);width:22px;height:24px;background:#323232;border-radius:5px}.stp-body-silhouette .torso{position:absolute;left:50%;top:75px;transform:translateX(-50%);width:var(--torso-width);height:160px;background:linear-gradient(180deg,#2d2d2d,#242424);clip-path:polygon(14% 0,86% 0,100% 100%,0 100%);transition:width .16s ease}.stp-body-silhouette .arm{position:absolute;top:82px;width:var(--arm-width);height:166px;background:#2b2b2b;border-radius:12px;transform-origin:50% 0;transition:width .16s ease}.stp-body-silhouette .arm.left{left:32px;transform:rotate(5deg)}.stp-body-silhouette .arm.right{right:32px;transform:rotate(-5deg)}.stp-body-silhouette .leg{position:absolute;top:228px;width:var(--leg-width);height:177px;background:#282828;border-radius:10px 10px 12px 12px;transition:width .16s ease}.stp-body-silhouette .leg.left{left:50px}.stp-body-silhouette .leg.right{right:50px}.stp-body-controls{display:grid;grid-template-columns:1fr 1fr;gap:16px;padding:14px 18px 16px;border-top:1px solid rgba(255,255,255,.07);background:rgba(5,5,5,.32)}.stp-body-row{min-width:0}.stp-body-rowhead{display:flex;justify-content:space-between;align-items:end;gap:6px;margin-bottom:5px}.stp-body-rowhead label{font-size:10px;text-transform:uppercase;letter-spacing:.1em;color:#cfcfc7;font-weight:850}.stp-body-rowhead strong{font-size:18px;font-weight:900;letter-spacing:-.03em;white-space:nowrap}.stp-body-rowhead strong span{font-size:10px;color:#85857f;font-weight:700}.stp-body-row input[type=range]{width:100%;accent-color:#f5a623;height:22px;margin:0}.stp-body-scale{display:flex;justify-content:space-between;color:#555550;font-size:9px;margin-top:-2px}.stp-body-note{padding:8px 24px 0;color:#62625d;font-size:10px;line-height:1.4;text-align:center}.stp-creation-footer{margin-top:auto;padding:12px 22px 22px}.stp-continue{width:100%;height:56px;border:0;border-radius:17px;font:inherit;font-size:15px;font-weight:900;background:#242424;color:#666}.stp-continue.ready{color:#0b0b0b;background:linear-gradient(90deg,#ff7a00,#f5a623);cursor:pointer}`;
