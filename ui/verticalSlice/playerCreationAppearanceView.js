...
<section class="stp-creation-appearance" data-stp-step="appearance">
  ...
  <section class="stp-creation-hero">
    ...
    <p class="stp-appearance-notice">${escapeHtml(vm.copy.notice).replace('\n', '<br>')}</p>
  </section>
