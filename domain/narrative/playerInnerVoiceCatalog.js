...
// soulagement, fierté, vertige, douleur ou résilience).
//
...
// Objectif canonique : maximum 150 phrases actives.
...
const ALLOWED_IDS = new Set([
  // Confiance / flow
  'confidence_001','confidence_003','confidence_006','confidence_007','confidence_009','confidence_010','confidence_011','confidence_012','confidence_015',
  ...
  'goal_002','goal_003','goal_004','goal_006','goal_008','goal_010','goal_011','goal_012',
  ...
  // Douleur / inquiétude
  'pain_002','pain_003','pain_004','pain_006','pain_007','pain_008',
  ...
  // Réactions brutes fortes — sélection très réduite
  'raw_frustration_001','raw_frustration_003','raw_frustration_010','raw_frustration_012','raw_frustration_014',
  'raw_joy_004','raw_joy_015','raw_joy_016','raw_joy_017',
  'raw_pain_003','raw_pain_004','raw_pain_006','raw_pain_008','raw_pain_011','raw_pain_017','raw_pain_020',
  'raw_surprise_005','raw_surprise_009','raw_surprise_015','raw_surprise_019',
  'raw_selfcrit_002','raw_selfcrit_005','raw_selfcrit_006','raw_selfcrit_010','raw_selfcrit_014','raw_selfcrit_017',
  'raw_drive_009','raw_drive_013','raw_drive_019',
  'raw_fear_001','raw_fear_002','raw_fear_003','raw_fear_004','raw_fear_005'
]);

export const PLAYER_INNER_VOICE_CATALOG = Object.freeze(
  SOURCE.filter(item => item?.id && ALLOWED_IDS.has(item.id)).slice(0,150)
);
