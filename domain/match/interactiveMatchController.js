...
function interactiveChoice(match, player, moment, index, previous = []) {
    ...
    const context = previous.length
        ? 'Le match a évolué. Ta dernière décision a changé la dynamique.'
        : 'Le match commence et le contexte est encore ouvert.';
...
export const InteractiveMatchController = {
