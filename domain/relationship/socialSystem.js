...
// Système social canonique : maintient les relations simples utilisées par le gameplay
// et la vie privée. Les relations riches restent la responsabilité de RelationshipSystem.
...
export class SocialSystem {
    ...
    modifyRelationship(state, characterId, amount) {
        ...
        return { characterId, before, after: rel.score, delta: rel.score - before, status: rel.status };
    }
