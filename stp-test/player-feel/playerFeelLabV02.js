...
function drawMannequin() {
  ...
  // Bras derrière le torse : ils permettent de lire l'équilibre et la rotation.
...
function render() {
  ...
  hud.textContent = `V0.2 · ${Math.round(p.speed)} u/s · ${p.mode} · appui ${p.plantedFoot}`;
}
