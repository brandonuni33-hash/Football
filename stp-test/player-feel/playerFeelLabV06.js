import { VIEWPORT, PITCH, FEEL_RULES, createPlayerFeelState, stepPlayerFeel, mannequinPose } from "./playerFeelModelV06.js";
...
function render() {
  ...
  const p = state.player;
  hud.textContent = `V0.6 · angle caméra ${cameraAngleDeg}° · ${Math.round(p.speed)} u/s · buste ${p.torsoLeanDegrees.toFixed(1)}° · ${p.mode}`;
}
